...
import { PromptType } from "@/services/storage/model"
...
function PromptButton({
	...
	return (
		<Hoverable
			...
			className={clsx(
				"flex justify-center rounded-lg border-2 m-2 border-slate-200",
				style
			)}>
			{onSave ? (
				<EditAbleText
				...
				<Text className="p-2 mx-1  rounded-lg">{content}</Text>
			)}
		</Hoverable>
	)
}
